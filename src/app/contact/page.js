  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white text-gray-900 min-h-screen">
      <div className="max-w-3xl mx-auto text-center space-y-3 mb-12">
        <span className="text-xs font-extrabold uppercase tracking-widest text-orange-500 bg-orange-50 border border-orange-100 px-3 py-1 rounded-full">
          Get In Touch
        </span>
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="mailto:support@hangover.com" className="text-orange-500 font-semibold hover:underline">
                    support@hangover.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 font-medium">HangOver Apparel HQ, Chennai, Tamil Nadu, India</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {status === 'unauthenticated' ? (
            <div className="py-12 text-center space-y-4">
              ...
              <p className="text-gray-600 text-sm max-w-md mx-auto">
                To send a message to customer support, please sign in to your HangOver account first.
              </p>
              <Link
                href="/login?callbackUrl=/contact"
                className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold px-8 py-3 rounded-xl text-xs transition shadow-md shadow-orange-500/20"
              >
            ...
            <div className="py-12 text-center space-y-4">
              ...
              <p className="text-gray-600 text-sm max-w-md mx-auto">
                Your message has been sent to the HangOver support team. You can check for replies in your email inbox or Admin dashboard.
              </p>
              <button
                onClick={() => setSubmitted(false)}
                className="inline-block bg-orange-500 text-white font-bold px-6 py-2.5 rounded-xl text-xs hover:bg-orange-600 transition shadow-md shadow-orange-500/20"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-3.5 rounded-xl transition text-xs shadow-md shadow-orange-500/20 flex items-center justify-center space-x-2 disabled:opacity-50"
              >
