        ...
        <div className="hidden md:flex items-center space-x-8 text-sm font-semibold text-gray-600">
          {isAdminPage ? (
            ...
            <>
              <Link
                ...
                className={`flex items-center space-x-1.5 transition ${
                  pathname.startsWith('/admin/products') ? 'text-indigo-600 font-bold' : 'hover:text-indigo-600'
                }`}
              >
              ...
              <Link
                href="/admin/orders"
                className={`flex items-center space-x-1.5 transition ${
                  pathname.startsWith('/admin/orders') ? 'text-indigo-600 font-bold' : 'hover:text-indigo-600'
                }`}
              >
              ...
              {/* Coupon Code Generator Link */}
              <Link
                href="/admin/coupons"
                className={`flex items-center space-x-1.5 transition ${
                  pathname.startsWith('/admin/coupons') ? 'text-indigo-600 font-bold' : 'hover:text-indigo-600'
                }`}
              >
              ...
              <Link
                href="/catalog"
                target="_blank"
                className="flex items-center space-x-1 text-gray-500 hover:text-indigo-600 transition text-xs font-bold bg-gray-50 px-3 py-1.5 rounded-lg border border-gray-200"
              >
            ...
            <>
              ...
              <Link href="/catalog?category=Shirts" className="hover:text-indigo-600 transition">
                Shirts
              </Link>
              <Link href="/catalog?category=Dresses" className="hover:text-indigo-600 transition">
                Dresses
              </Link>
              <Link href="/catalog?category=Jackets" className="hover:text-indigo-600 transition">
                Jackets
              </Link>
            </>
          )}
